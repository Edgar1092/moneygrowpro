...
class PassengerCreateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'emergency_contacts.*.first_name'   =>  'required_with:emergency_contacts|string|max:50',
            'emergency_contacts.*.last_name'    =>  'required_with:emergency_contacts|string|max:50',
            'emergency_contacts.*.phone_1'      =>  'nullable|string|max:20',
            'emergency_contacts.*.phone_2'      =>  'nullable|string|max:20',
            'emergency_contacts.*.email'        =>  'nullable|string|max:100|email',
